<template>
  <div id="chat" class="row" style="height: 100vh;">
    <div
      id="chatList"
      class="col-md-3 border-dark border-right d-none d-md-block"
    ...
    <div id="chatList" class="col-md-3 border-dark border-right d-md-none">
      <ol>
        <li v-for="chatroom in chatrooms">
          <a
            href="javascript:;"
